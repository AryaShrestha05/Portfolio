...
export default function SmokeyCursor({
  ...
  useEffect(() => {
    ...
    function generateColor() {
      // Gray smoke - random brightness between 0.3 and 0.7
      const gray = 0.3 + Math.random() * 0.4;
      const intensity = 0.08; // Lower intensity for subtle smoke
      return { r: gray * intensity, g: gray * intensity, b: gray * intensity };
    }
